...
const agendaData = ref([
  ...
  },
  {
    ...
    details: "Advanced machine learning techniques, LLMs, and Generative AI applications.",
    highlight: false,
    isBreak: false,
  },
  {
    time: "12:45 PM – 1:00 PM",
    title: "Session 6: Women in Tech",
    speakers: "<strong>Shruti Tiwari</strong> <em>(Women in Tech)</em>",
    details: "Empowering women in technology with insights and strategies for success.",
    highlight: false,
    isBreak: false,
  },
  {
